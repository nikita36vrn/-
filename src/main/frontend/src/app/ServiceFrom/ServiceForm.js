...
export default class ServiceForm extends Component {
    ...
    handleChange = (e) => {
        ...
        const result = Object.assign({}, fields, {[e.target.name]:{value: e.target.value, label: e.target.placeholder}});
    ...
    submitForm = () =>{
        ...
        params.name = 'Запись на прием к ветеринару';
    ...
    render() {
        return (
            <div>
                ...
                {this.state.stepNumber === 2 ? <ThirdStep nextStep ={this.nextStep} prevStep = {this.prevStep} submitForm={this.submitForm}/> :null}
            </div>
        )
    }
