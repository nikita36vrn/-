    ...
    render() {
        return (
            <div>
                ...
                {this.state.stepNumber === 1 ?  <SecondStep prevStep={this.prevStep} nextStep={this.nextStep}/> :null}
                {this.state.stepNumber === 2 ?  <ThirdStep prevStep={this.prevStep} nextStep={this.nextStep}/> :null}
            </div>)
    }
}