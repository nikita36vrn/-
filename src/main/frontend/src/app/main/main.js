...
export default class Main extends Component {
    ...
    state = {
        listService: [],listServiceFiltered: []
    };
    ...
    render() {
        ...
        return (
            ...
            {this.state.listServiceFiltered.length ? <div>

                    <div className="ui three cards">{
                        this.state.listServiceFiltered.map((item) => {
                            return (<Link to={'/' +item.id} className="ui card" key={item.id}>
                                    <div className="content">
                                        <img
                                            src={icons[item.id]}
                                            className="ui floated mini right image"
                                        />
