...
public class ProductServiceController {
    ...
    @RequestMapping(value= "listCategories", method = RequestMethod.POST,
            produces = "application/json")
    public List<CategoryEntity> listCategories() {
        return kotoService.listCategories();
    }

    @RequestMapping(value= "getKotoServiceById", method = RequestMethod.POST,
            produces = "application/json")
    public KotoServiceEntity getKotoServiceById(@RequestBody String id) {
        return kotoService.getServiceById(id);
    }
}
